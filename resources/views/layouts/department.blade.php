...
<body>
    <div id="app">
            ...
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="logo_laravel">
                        <img src="{{ asset('images/logo.png') }}" alt="Gestore HR" style="width: 150px">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('departments.index') }}">Dipartimenti
                                    </a>
                                    <a class="dropdown-item" href="{{ route('employees.index') }}">Dipendenti
                                    </a>
                                    <a class="dropdown-item" href="{{ route('skills.index') }}">Skills
                                    </a>
        ...
        <div class="container">
            <h1 class="mt-3 text-center">@yield('title')</h1>
